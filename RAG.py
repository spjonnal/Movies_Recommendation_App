...
async def ask_llm(request: ConversationRequest):
    ...
    Guidelines:
    - Focus only on movies. If topic goes off-track, do not encourage it. Inform that your responds only to movie information and anything other than that will be ignored strictly because some one might use you for wrongful purposes.
